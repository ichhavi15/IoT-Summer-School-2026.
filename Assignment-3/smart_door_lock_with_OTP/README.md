...
--Overview--
This repository contains the firmware for an ESP32-based Smart Door Lock that uses a two-factor authentication method for university hostel entry.
The system requires a static 4-digit Student ID followed by a dynamically generated 6-digit One-Time Password (OTP).
